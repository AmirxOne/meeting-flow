...
const FEATURES = [
  {
    icon: CalendarPlus,
    title: "درخواست جلسه، بدون ورود",
    desc: "کارکنان درخواست می‌دهند («با چه کسی، چقدر، چقدر فوری») و مدیریت زمان و اتاق را هماهنگ می‌کند — مهمانان بیرونی هم بدون حساب می‌توانند درخواست بدهند.",
  },
  {
    icon: CalendarDays,
    title: "تقویم شمسی با درگ‌اند‌دراپ",
    desc: "جلسه را با ماوس بکشید: به روز دیگر، ساعت دیگر، یا با پنل لبه‌ی تقویم به هر ماهِ دیگری — با تأیید شمسی پیش از ثبت.",
  },
  {
    icon: ShieldCheck,
    title: "صورت‌جلسه‌ی محرمانه",
    desc: "خلاصه، متن کامل، دستور جلسه و موضوعات مطرح‌شده — با محرمانگی مستقل برای هر بخش و گردش‌کار پیش‌نویس، تأیید و نهایی‌سازی.",
  },
  {
    icon: DoorOpen,
    title: "QR اتاق‌ها",
    desc: "هر اتاق QR خودش را دارد؛ اسکن کنید و برنامه‌ی زنده‌ی اتاق را بدون ورود ببینید — جلسات محرمانه فقط «مشتغل» دیده می‌شوند.",
  },
  {
    icon: Shield,
  ...
  {
    icon: BarChart3,
    title: "گزارش شخصی و مدیریتی",
    desc: "هر نفر آمار جلسات خودش را می‌بیند (ساعت‌ها، همکاران پرتکرار، موضوعات)؛ مدیران گزارش کامل سازمان را با خروجی CSV.",
  },
] as const;

const STEPS = [
  { n: 1, title: "درخواست", desc: "کارمند نیازش را ثبت می‌کند — موضوع، افراد، فوریت و مدت؛ مهمان بیرونی هم از صفحه‌ی عمومی." },
  { n: 2, title: "هماهنگی", desc: "مدیریت از صف درخواست‌ها جلسه را می‌چیند؛ زمان آزاد و اتاق مناسب پیشنهاد می‌شود." },
  { n: 3, title: "برگزاری", desc: "دعوت‌ها ارسال می‌شود، حضور ثبت می‌شود، تغییرات با درگ‌اند‌دراپ تقویم همان لحظه اعمال می‌شود." },
  { n: 4, title: "صورتجلسه و گزارش", desc: "دبیر جلسه صورت‌جلسه‌ی محرمانه را ثبت و برای تأیید ارسال می‌کند؛ آمار در گزارش‌ها جمع می‌شود." },
] as const;
