...
export const TYPE_HINT_FA: Record<string, string> = {
  SOLO: "اتاق را فقط برای خودتان رزرو می‌کنید — بدون دعوت‌شونده و بدون لینک ویدئو",
  ONLINE: "جلسه آنلاین — لینک گوگل‌میت/تیمز/زوم را وارد کنید؛ دعوت‌شونده حضوری لازم نیست",
  INTERNAL: "جلسه بین همکاران همان سازمان — بدون مهمان بیرونی",
  EXTERNAL: "با مهمان بیرونی — نیازمند تأیید اپراتور خواهد بود",
  ONE_ON_ONE: "جلسه‌ی دو نفره با یک همکار یا مهمان",
  GROUP: "جلسه‌ی گروهی با چند دعوت‌شونده",
  INTERVIEW: "مصاحبه‌ی استخدامی — معمولاً کوتاه و دو طرفه",
  CLIENT: "جلسه با مشتری — نیازمند تأیید اپراتور خواهد بود",
  QUICK: "جلسه‌ی سریع و کوتاه — کمترین تشریفات",
};
